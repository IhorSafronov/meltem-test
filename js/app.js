(() => {
    ...
    da.init();
    const cookiesButton = document.querySelector(".сookies__button");
    if (cookiesButton) cookiesButton.addEventListener("click", (function() {
        const cookiesBlock = document.querySelector(".сookies");
        if (cookiesBlock) cookiesBlock.style.display = "none";
    }));
    const buttonCall = document.querySelector(".action-header__button.button-call");
    const modalClosedButton = document.querySelector(".modal__closed");
    ...
    const submitButton = document.querySelector(".form-modal__button");
    submitButton.addEventListener("click", (function(event) {
        event.preventDefault();
        hero.classList.add("thanks-modal-open");
        setTimeout((function() {
            hero.classList.remove("thanks-modal-open", "modal-open");
        }), 2e3);
    }));
    window["FLS"] = true;
    isWebp();
